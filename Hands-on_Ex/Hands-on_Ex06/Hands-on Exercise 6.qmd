...
-   *_timestamp_* field stores date-time values in POSIXct format.

-   *_source_country_* field stores the source of the attack. It is in *ISO 3166-1 alpha-2* country code.

-   *_tz_* field stores time zone of the source IP address.
